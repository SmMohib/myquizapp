import 'package:myquizapp/theme/config.dart' as config;
import 'package:myquizapp/ui/widgets/card.dart';
import 'package:myquizapp/ui/widgets/sectionHeader.dart';
import 'package:myquizapp/ui/widgets/statsCard.dart';
              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: AnimatedContainer(
                    margin: local
                        ? EdgeInsets.only(
                            left: MediaQuery.of(context).size.width * 0.32 - 35)
                        : EdgeInsets.only(
                            left:
                                MediaQuery.of(context).size.width * 0.65 - 10),
                    width: 40,
                    height: 4,
